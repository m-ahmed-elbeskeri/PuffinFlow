def run_flow():
    ...
    get_first = prompts.ask(question='Enter the first number:', type='number')

    # Step: get_second (prompts.ask)
    get_second = prompts.ask(question='Enter the second number:', type='number')

    # Step: get_third (prompts.ask)
    get_third = prompts.ask(question='Enter the third number:', type='number')
